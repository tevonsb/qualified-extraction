            ...
            if isLoading {
                ...
                VStack(spacing: 24) {
                    ...
                    LazyVGrid(columns: [
                        ...
                        StatCard(value: stats.sent, label: "Sent", color: .blue)
                        StatCard(value: stats.received, label: "Received", color: .green)
                        StatCard(value: stats.total, label: "Total", color: .pink)
                    }
                    .padding(.horizontal)
